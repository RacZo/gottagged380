...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class User {
    ...
    public class Get extends UserendpointRequest<com.google.api.services.userendpoint.model.User> {
     ...
     * @return the request
     */
    public Insert insert(com.google.api.services.userendpoint.model.User content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends UserendpointRequest<com.google.api.services.userendpoint.model.User> {
       ...
       * @since 1.13
       */
      protected Insert(com.google.api.services.userendpoint.model.User content) {
     ...
     * @return the request
     */
    public Patch patch(java.lang.String id, com.google.api.services.userendpoint.model.User content) throws java.io.IOException {
      Patch result = new Patch(id, content);
      initialize(result);
      return result;
    }

    public class Patch extends UserendpointRequest<com.google.api.services.userendpoint.model.User> {
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String id, com.google.api.services.userendpoint.model.User content) {
        super(Userendpoint.this, "PATCH", REST_PATH, content, com.google.api.services.userendpoint.model.User.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(com.google.api.services.userendpoint.model.User content) throws java.io.IOException {
      Update result = new Update(content);
      initialize(result);
      return result;
    }

    public class Update extends UserendpointRequest<com.google.api.services.userendpoint.model.User> {
       ...
       * @since 1.13
       */
      protected Update(com.google.api.services.userendpoint.model.User content) {
