...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the Username collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Userendpoint userendpoint = new Userendpoint(...);}
   *   {@code Userendpoint.Username.List request = userendpoint.username().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  /**
   * The "username" collection of methods.
   */
  public class Username {

    /**
     * Create a request for the method "username.check".
     *
     * This request holds the parameters needed by the the userendpoint server.  After setting any
     * optional parameters, call the {@link Check#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.gottagged380.userendpoint.model.UserName}
     * @return the request
     */
    public Check check(com.gottagged380.userendpoint.model.UserName content) throws java.io.IOException {
      Check result = new Check(content);
      initialize(result);
      return result;
    }

    public class Check extends UserendpointRequest<com.gottagged380.userendpoint.model.UserName> {

      private static final String REST_PATH = "checkUserName";
       ...
       * @since 1.13
       */
      protected Check(com.gottagged380.userendpoint.model.UserName content) {
        super(Userendpoint.this, "POST", REST_PATH, content, com.gottagged380.userendpoint.model.UserName.class);
      }
